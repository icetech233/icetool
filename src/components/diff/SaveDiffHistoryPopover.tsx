/**
 * SaveDiffHistoryPopover —— 保存文本差异到历史记录的迷你 Popover。
 *
...
import { autoTitle } from '../../utils/storage/diffDB';

interface SaveDiffHistoryPopoverProps {
  open: boolean;
...
export default function SaveDiffHistoryPopover({
  open,
  anchor,
  canSave,
  onClose,
  onSave,
}: SaveDiffHistoryPopoverProps) {
        ...
        >
          ...
          <div className="relative">
            <input
              ...
              placeholder={canSave ? '标题（建议填写）' : '未输入文本，无法保存'}
              disabled={!canSave}
