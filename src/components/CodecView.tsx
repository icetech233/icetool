      ...
      >
        ...
        <div className="ml-auto flex items-center gap-2">
          <button
            ...
            onClick={swap}
            disabled={!output}
            className="inline-flex items-center gap-1 rounded-md border border-border px-3 py-1.5 text-xs text-foreground transition-colors hover:bg-muted disabled:opacity-40 disabled:hover:bg-transparent"
            title="把输出灌回输入并切换方向"
          >
